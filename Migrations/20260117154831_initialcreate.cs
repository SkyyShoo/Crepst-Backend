        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumPages = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Extraits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Extraits_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Extraits_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 6, 1, 14, 25, 2, 0, DateTimeKind.Utc), 1, "Un extrait fascinant", null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Extraits_EventId",
                table: "Extraits",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_Extraits_UserId",
                table: "Extraits",
                column: "UserId");
        }
